...
?>
    <form action="" method="POST">
        <div class="mb-3">
            ...
            <label for="inputPasswordConfirmed" class="form-label">  </label>
            <input type="password" name ="passsword_confirmed" class="form-control" id="inputPasswordConfirmed" placeholder="Укажите пароль ещё раз" required>
        </div>
